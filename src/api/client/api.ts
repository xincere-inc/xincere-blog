  ...
  return {
    ...
    async adminGetAuthors(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<AdminGetAuthors200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.adminGetAuthors(
        adminGetAuthorsRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.adminGetAuthors']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const AdminApiFactory = function (
  ...
  return {
    ...
    adminGetAuthors(
      ...
      return localVarFp
        .adminGetAuthors(adminGetAuthorsRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
