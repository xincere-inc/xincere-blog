...
export const CommentsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    adminDeleteComments: async (
      adminDeleteCommentsRequest: AdminDeleteCommentsRequest,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
export const CommentsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminDeleteComments(
          adminDeleteCommentsRequest,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CommentsApi.adminDeleteComments']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async postComment(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<PostComment201Response>
    > {
...
export const CommentsApiFactory = function (
  ...
  return {
    ...
    adminDeleteComments(
      ...
      return localVarFp
        .adminDeleteComments(adminDeleteCommentsRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Retrieves comments for a specific article with pagination (10 comments per page). Excludes comments where deletedAt is not null. Includes all comments regardless of status.
    ...
    getComments(
      ...
      return localVarFp
        .getComments(articleId, page, limit, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Allows authenticated or unauthenticated users to post a comment on an article. Requires name, email, and content. Associates the comment with the authenticated user if logged in.
    ...
    postComment(
      ...
      return localVarFp
        .postComment(postCommentRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
