...
export interface AdminGetCategories200Response {
    /**
     * 
     * @type {Array<AdminCreateCategory201ResponseCategory>}
     * @memberof AdminGetCategories200Response
     */
    'data'?: Array<AdminCreateCategory201ResponseCategory>;
    /**
     * 
 ...
 * 
 * @export
 * @interface AdminGetCategoriesRequest
 */
export interface AdminGetCategoriesRequest {
    /**
     * 
     * @type {number}
     * @memberof AdminGetCategoriesRequest
     */
    'page'?: number;
    /**
     * 
...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Retrieves categories from the database with pagination and optional search.
         * @summary Fetch categories with pagination and search
         * @param {AdminGetCategoriesRequest} adminGetCategoriesRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        adminGetCategories: async (adminGetCategoriesRequest: AdminGetCategoriesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'adminGetCategoriesRequest' is not null or undefined
            assertParamExists('adminGetCategories', 'adminGetCategoriesRequest', adminGetCategoriesRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(adminGetCategoriesRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        adminGetTags: async (adminGetCategoriesRequest: AdminGetCategoriesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'adminGetCategoriesRequest' is not null or undefined
            assertParamExists('adminGetTags', 'adminGetCategoriesRequest', adminGetCategoriesRequest)
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async adminGetCategories(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdminGetCategories200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.adminGetCategories(adminGetCategoriesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async adminGetTags(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdminGetTags200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.adminGetTags(adminGetCategoriesRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        adminGetCategories(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig): AxiosPromise<AdminGetCategories200Response> {
            return localVarFp.adminGetCategories(adminGetCategoriesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves tags from the database with pagination and optional search.
         * @summary Fetch tags with pagination and search
         ...
         * @throws {RequiredError}
         */
        adminGetTags(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig): AxiosPromise<AdminGetTags200Response> {
            return localVarFp.adminGetTags(adminGetCategoriesRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves users from the database with pagination and optional search.
         * @summary Fetch users with pagination and search
...
export class AdminApi extends BaseAPI {
     ...
     * @memberof AdminApi
     */
    public adminGetCategories(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig) {
        return AdminApiFp(this.configuration).adminGetCategories(adminGetCategoriesRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AdminApi
     */
    public adminGetTags(adminGetCategoriesRequest: AdminGetCategoriesRequest, options?: RawAxiosRequestConfig) {
        return AdminApiFp(this.configuration).adminGetTags(adminGetCategoriesRequest, options).then((request) => request(this.axios, this.basePath));
    }
