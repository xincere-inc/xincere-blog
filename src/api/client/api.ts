...
=======
   ...
   */
  pagination?: AdminGetCategories200ResponsePagination;
>>>>>>> 0565384 (feat: api function added to delete existing categories)
}
/**
 *
 * @export
...
export const AdminApiAxiosParamCreator = function (
  ...
  return {
    ...
    adminGetCategories: async (
      adminGetCategoriesRequest: AdminGetCategoriesRequest,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
=======
    adminGetCategories(
      ...
      return localVarFp
        .adminGetCategories(adminGetCategoriesRequest, options)
        .then((request) => request(axios, basePath));
    },
>>>>>>> 0565384 (feat: api function added to delete existing categories)
    /**
